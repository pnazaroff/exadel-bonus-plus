...
namespace ExadelBonusPlus.WebApi.v23
{
    [ApiVersion("2.3")]
    [ApiController]
    [Route("api/v{version:apiVersion}/bonuses/")]
    public class BonusController_v23 : ControllerBase
    {
        private readonly ILogger<BonusController> _logger;
        private readonly IBonusService _BonusService;
        
        public BonusController_v23(ILogger<BonusController> logger, IBonusService BonusService)
        {
            _logger = logger;
